#ifndef BLASTERATTACKLEVEL_6_H // Change headers when coping
#define BLASTERATTACKLEVEL_6_H
...
class BlasterAttackLevel_6 : public AttackLevels { // Change class name and constructor and destructor when copying
    private:
        vector<BlasterData> blasters;
        bool inAttack;
    public:
        BlasterAttackLevel_6() {
