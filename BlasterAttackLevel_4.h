#ifndef BLASTERATTACKLEVEL_4_H // Change headers when coping
#define BLASTERATTACKLEVEL_4_H
...
class BlasterAttackLevel_4 : public AttackLevels { // Change class name and constructor and destructor when copying
    private:
        vector<BlasterData> blasters;
        bool inAttack;
    public:
        BlasterAttackLevel_4() {
            // Creating the blasters
            blasters.emplace_back(Vector2f(-10, 0), Vector2f(3, 3), 0, Vector2f(320, 120), 5, 0, 1);
        }
