#ifndef BLASTERATTACKLEVEL_7_H // Change headers when coping
#define BLASTERATTACKLEVEL_7_H
...
class BlasterAttackLevel_7 : public AttackLevels { // Change class name and constructor and destructor when copying
    private:
        vector<BlasterData> blasters;
        bool inAttack;
    public:
        BlasterAttackLevel_7() {
            // Creating the blasters
            blasters.emplace_back(Vector2f(650, 245), Vector2f(3, 3), 0, Vector2f(600, 305), 5, 90, 1);
        }
