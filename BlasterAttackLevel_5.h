#ifndef BLASTERATTACKLEVEL_5_H // Change headers when coping
#define BLASTERATTACKLEVEL_5_H
...
class BlasterAttackLevel_5 : public AttackLevels { // Change class name and constructor and destructor when copying
    private:
        vector<BlasterData> blasters;
        bool inAttack;
    public:
        BlasterAttackLevel_5() {
